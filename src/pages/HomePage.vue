  ...
  <section class="home-hero" aria-labelledby="home-title">
    ...
    <div class="container home-hero__content">
      ...
      <div class="hero-actions">
        ...
        <el-button
          tag="a"
          href="https://cdn.jsdelivr.net/gh/waveletlab-uestc/oos@271b5494f91c1869d5d3d590b8ab02d682295ef4/CallforPaper-EN260731.pdf"
          size="large"
        >
          {{ t('home.callForPaper') }}
        </el-button>
  ...
  <div class="container content-layout home-layout">
    ...
    <article class="content-panel">
      <section class="section-block">
        <img
          class="intro-image"
          src="https://cdn.jsdelivr.net/gh/waveletlab-uestc/oos@a3c4e01cb9bc453d7057b099fd0f4a1a4a7125e0/2026/introduction2026.png"
