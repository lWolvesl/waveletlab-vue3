...
const sharedConferenceLinks = {
  ...
  cmtUrl: 'https://cmt3.research.microsoft.com/ICCWAMTIP2026',
...
export const messages = {
  en: {
    ...
    routes: {
      ...
      contact: 'Contact',
      news: 'News',
      onlineMeeting: 'Participation Information',
    },
    conference: {
    ...
    downloadLinks: [
      { label: 'Call for Paper (EN)', href: `${assetCdnBase}/CallforPaper-EN260731.pdf`, download: 'CallforPaper-EN.pdf' },
    ...
    home: {
      ...
      onlineMeetingTitle: 'Participation Information',
    ...
    importantDates: [
      { event: 'Submission Deadline', date: 'August 31st, 2026' },
      { event: 'Acceptance Notification', date: 'September 10th, 2026' },
    ...
    latestNews: [
      ...
      {
        date: '2026-07-07',
        text: 'Updated the call for papers schedule: submission closes on August 10th, 2026, acceptance notification is on September 10th, 2026, and the conference ceremony is on September 19th, 2026.',
      },
      {
        date: '2023-12-29',
    ...
    timelineRows: [
      { event: 'Submission', schedule: 'Submission closed: August 31st, 2026' },
      { event: 'Acceptance Notification', schedule: 'Date: September 10th, 2026' },
      { event: 'Conference Ceremony', schedule: 'Date: September 19th, 2026' },
      { event: 'Conference', schedule: 'Dates: September 19 - 21, 2026' },
    ],
    routine: [
    ...
    guidance: {
      ...
      submissionRequirements: {
        title: 'Submission Requirements by Stage',
        languageNotice: 'Only English manuscripts are accepted for this conference.',
        initial: {
          label: 'Initial Submission',
          stage: 'Manuscript review stage',
          text: 'Submit only the PDF manuscript for peer review. Source files are not required at this stage.',
        },
        cameraReady: {
          label: 'Camera-ready',
          stage: 'After acceptance',
          text: 'This is the stage where source files are required. In addition to the final PDF, please upload:',
          items: [
            {
              label: 'LaTeX users:',
              textBefore: ' All ',
              fileTypes: ['.tex', '.cls', '.bib'],
              separator: ', ',
              packageBefore: ' files and figures, packaged into one ',
              packageType: '.zip',
              textAfter: ' file.',
            },
            {
    ...
    onlineMeetingPage: {
      ...
      breadcrumb: 'Participation Information',
      description: 'On-site venue and online Tencent Meeting information for ICCWAMTIP 2026.',
      heading: 'Participation Information',
      intro: 'ICCWAMTIP 2026 is about to begin. The conference arrangements are announced as follows. On-site participants please come to the venue below, and online participants may join through Tencent Meeting.',
      rows: [
        ...
        { label: 'Time', value: 'Saturday, September 19, 8:50 AM' },
        { label: 'On-site venue', value: 'Yanshi Hall, School of Computer Science, 3rd Floor, Main Building B1, Qingshuihe Campus, University of Electronic Science and Technology of China' },
        { label: 'Online meeting (Tencent Meeting ID)', value: '600 421 404' },
        { label: 'Phone dial-in (Chinese Mainland)', value: '+86 (0)755 36550000' },
      ],
      note: 'Please arrive at the venue or join the online meeting 10 minutes in advance and get prepared. Thank you for your support and cooperation!',
    },
    speakersPage: {
      title: 'Speakers',
      breadcrumb: 'Speakers',
    ...
    timelinePage: {
      ...
      description: 'Important milestones for submission, acceptance notification, conference ceremony, and conference dates.',
  ...
  zh: {
    ...
    downloadLinks: [
      { label: '征稿通知（英文）', href: `${assetCdnBase}/CallforPaper-EN260731.pdf`, download: 'CallforPaper-EN.pdf' },
    ...
    importantDates: [
      { event: '投稿截止', date: '2026年8月31日' },
      { event: '录用通知', date: '2026年9月10日' },
      { event: '举办日期', date: '2026年9月19日' },
    ],
    catalogNumbers,
    latestNews: [
    ...
    timelineRows: [
      { event: '投稿', schedule: '截稿日期：2026年8月31日' },
      { event: '录用通知', schedule: '通知日期：2026年9月10日' },
      { event: '举办日期', schedule: '日期：2026年9月19日' },
    ...
    guidance: {
      ...
      submissionRequirements: {
        title: '各阶段提交要求',
        languageNotice: '会议只允许英文投稿。',
        initial: {
          label: '初稿（Initial Submission）',
          stage: '审稿阶段',
          text: '只要求提交 PDF 用于同行评审，初稿阶段不需要上传源文件。',
        },
        cameraReady: {
          label: '最终稿（Camera-ready）',
          stage: '录用后阶段',
          text: '此阶段必须提交源文件。除了最终的 PDF，你通常还需要上传：',
          items: [
            {
              label: 'LaTeX 用户：',
              textBefore: '所有 ',
    ...
    onlineMeetingPage: {
      title: '参会信息',
      breadcrumb: '参会信息',
      description: 'ICCWAMTIP 2026 线下会场及腾讯会议线上参会信息。',
      heading: '参会信息',
      intro: 'ICCWAMTIP 2026 国际会议即将召开，现将会议安排通知如下：',
      rows: [
      ...
      note: '请参会人员提前 10 分钟到场 / 入会，做好准备工作。感谢大家的支持与配合！',
    },
    speakersPage: {
      title: '大会报告',
      breadcrumb: '大会报告',
    ...
    timelinePage: {
      title: '会议日程',
      breadcrumb: '会议日程',
      description: '投稿、录用通知、举办日期和会议日期的重要时间节点。',
      heading: '会议日程',
    },
  },
}
